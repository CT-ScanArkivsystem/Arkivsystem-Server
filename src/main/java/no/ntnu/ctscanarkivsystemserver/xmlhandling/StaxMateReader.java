...
public class StaxMateReader {
     ...
     * @return DicomAttributeObjectList a list which will contain DicomAttributeObjects.
     ...
     */
    public ArrayList<DicomAttributeObject> parse(String path) throws XMLStreamException, FileNotFoundException  {
     ...
     * @throws XMLStreamException If something goes wrong with the iterating over the document.
     */
    private void handleRootChildElement(ArrayList<DicomAttributeObject> dicomAttributeObjectList, SMInputCursor rootChildCursor) throws XMLStreamException {
     ...
     * @throws XMLStreamException If something goes wrong with the iterating over the document.
     */
    private void handleValueElement(DicomAttributeObject dicomAttributeObject, SMInputCursor valueCursor) throws XMLStreamException {
